...
<body>
    ...
    <div class="contenedor-cartas">
        ...
        <div class="carta-libro">
            <img src="img/odisea.webp" alt="Portada Libro 1">
            <h3>Odisea</h3>
            <p><strong>Autor:</strong> Homero</p>
            <p><strong>Fecha:</strong> Epoca Antigua</p>
        </div>

        <!-- Carta 2 -->
        <div class="carta-libro">
            <img src="img/romeoyjulieta.webp" alt="Portada Libro 2">
            <h3>Romeo y Julieta</h3>
            <p><strong>Autor:</strong> William Shakespeare</p>
            <p><strong>Fecha:</strong> 1597</p>
        </div>

        <!-- Repite hasta la carta 6 -->
        <div class="carta-libro">
            <img src="img/donquijote.webp" alt="Portada Libro 3">
            <h3>Don Quijote de la mancha</h3>
            <p><strong>Autor:</strong> Miguel de Cervantes</p>
            <p><strong>Fecha:</strong> 1605</p>
        </div>
